...
class config  :
    ...
    def __init__ (self,
                  ...
                  var_to_exclude = ['number', 'area_skm', 'area_spg'],
                  scale_factor=1,
                  ) :
...
configs['P2'] = config('P2', fname_original = 'base', fname_modified = 'shift20', axis_label_modified = 'ref. object shifted by 20 pixel')
...
configs['P1'] = config('P9', fname_original = 'base', fname_modified = 'plusObj', axis_label_modified = 'with one additional object')
...
configs['F2'] = config('F2', fname_original = 'base', fname_modified = '30_min_late', axis_label_modified = '30 minutes later')
