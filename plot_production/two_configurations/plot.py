...
if __name__ == '__main__':
    ...
    print('property:', args.property, ' \t use_values:', args.use_values, '\t use_original:', args.use_original)
    ...
    if not args.use_original :       path = f'../../data_production/anomaly/output/{args.dataset}/{args.property}/'
    ...
    if args.selected_number > 0 :
        #idx_to_select = df_original['number_original'] == args.selected_number
