...
parser.add_argument("-d", "--dataset",  default="TOOCAN_10_120", help="name of the dataset")
parser.add_argument("-p", "--property", default="P9",     help="property to plot")
parser.add_argument("-n", "--selected_number", default=0, type=int,     help="property to plot")
...
if __name__ == '__main__':
    ...
    path_id = f'{args.dataset}/{folder1}/{folder2}/{args.property}/'
    ...
    perturbation_txt = 'Perturbation '
    if args.property == 'P9' : perturbation_txt = perturbation_txt + '(1)'
    if args.property == 'P1' : perturbation_txt = perturbation_txt + '(1)'
    if args.property == 'P2' : perturbation_txt = perturbation_txt + '(3)'
    if args.property == 'P3' : perturbation_txt = perturbation_txt + '(2)'
    if args.property == 'P4' : perturbation_txt = perturbation_txt + '(P4)'
    if args.property == 'P5' : perturbation_txt = perturbation_txt + '(4)'
    if args.property == 'F1' : perturbation_txt = perturbation_txt + '(5)'
    if args.property == 'F2' : perturbation_txt = perturbation_txt + '(6)'
    if args.property == 'F3' : perturbation_txt = perturbation_txt + '(F2)'
    if args.property == 'F4' : perturbation_txt = perturbation_txt + '(7)'
    ...
    for vs in var_to_plot.keys() :
        ...
        plt.text(0.03, 0.93, perturbation_txt, weight='bold', transform = ax.transAxes, size=18)
