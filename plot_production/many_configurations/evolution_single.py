...
def evolution_single( METRIC,
    ...
    for fname_modified in config.cases :
        ...
        df_modified  = pd.read_csv( f'{path}{fname}{Property}_{fname_modified}.csv')
        ...
        df_modified_corr  = pd.read_csv( f'{path_corr}{Property}_{fname_modified}.csv')
        df_original_corr  = pd.read_csv( f'{path_corr}{Property}_base.csv')
