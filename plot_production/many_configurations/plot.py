...
parser.add_argument("-p", "--property", default="F1",     help="property to plot")
...
if __name__ == '__main__':
    ...
    #print(f'{path}{fname}{args.property}_{config.fname_original}.csv\n', df_original)
    ...
    evolution_all( METRICS,
                   ...
                   config,
                   figname    = 'correlation',
                   ylabel     = 'correlation with ref.' if args.property!='F2' else 'auto-correlation',
                   folder_out = folder_out,
                   use_values = args.use_values,
                   extra_text = ''
                   )
